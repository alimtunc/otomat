...
export function LinearOnboardingPanel() {
  ...
  if (connections.data.length === 0) return null;
      ...
      {hostProjects.length === 0 ? (
        <>
          ...
          <p className="text-xs text-text-tertiary">
            Otomat imports issues into a project. Add the repository you want to work on, then pick
        ...
        <>
          ...
          <p className="text-xs text-text-tertiary">
            Nothing is imported until you pick this project&apos;s connection and the team or Linear
            project whose issues belong to it — Otomat never guesses one. The first import starts as
            soon as you map it.
          </p>
          <div>
            <Link
