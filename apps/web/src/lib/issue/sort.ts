import { ISSUE_BOARD_COLUMNS, projectIssuePrimaryState, type IssueSummary } from "@otomat/domain";
...
function compare(a: IssueSummary, b: IssueSummary, sort: IssueSort): number {
...
export function sortIssues(issues: IssueSummary[], sort: IssueSort): IssueSummary[] {
